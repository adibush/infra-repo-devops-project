...
- Infrastructure code: Kubernetes and Argo CD manifests
...
flowchart TD
    ...
    argocd["Argo CD<br/>Watches infra repository"]
...
| Argo CD | Keeps Kubernetes synchronized with Git |
| ConfigMap | Stores non-secret backend configuration |
| Secret | Stores locally-created MongoDB credentials and keyfile; real values are not committed |
